...
if ( class_exists( 'GFForms' ) ) {
    ...
    class RWListFieldCalculations extends GFAddOn {
        ...
        public function init(){
            ...
            add_filter( 'gform_pre_render', array( $this, 'list_field_calculations_pre_render' ) );
        ...
        public function scripts() {
            $scripts = array(
                array( 'handle' => 'LFCalc',
                      'src'     => $this->get_base_url() . '/js/LFCalc.js',
                      'version' => $this->_version,
                      'deps'    => array( 'jquery', 'gform_gravityforms' ),
                      'enqueue' => array(
                          array( 'field_types' => 
                                array( 'list','calculation' )
                               )
                      )
                ),
        ...
        function list_field_calculations_pre_render( $form ) {
